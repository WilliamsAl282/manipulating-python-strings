...
> It will show the word "Taylor Swift" and then show the number of charcters in "Taylor Swift"
...
print(num_chars)
```
> It will show the number of characters in the variable "full_name"
